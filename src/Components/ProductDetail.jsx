    ...
    return(
        ...
        <Cart/>
              ...
              <div className="price">
                <p>US </p> <strong>${product.price}</strong>
                    ...
                    <div className="infoShip">
                        <span className="dot"></span><p> {product.warrantyInformation}</p>
                        <span className="dot"></span><p>{product.shippingInformation}</p>
                    </div>
            ...
            <div className="commentsTitle">
                <h2><MessageCircle className="messageIcon"/>Comments:</h2>
            </div>
             ...
             <div className="commentsSection">
                 <div className="comments">
                    ...
                    <div className="firstComment">
                        <h4 className="rating"><Star size={15}/>Rating: {product.reviews[0].rating}</h4>
                    ...
                    <div className="secondComment">
                        <h4 className="rating"><Star size={15}/>Rating: {product.reviews[1].rating}</h4>
                    ...
                    <div className="thirdComment">
                         <h4 className="rating"><Star size={15}/>Rating: {product.reviews[2].rating}</h4>
